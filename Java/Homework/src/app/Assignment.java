...
* @author Gunnar Hoglund, Dr. Javier Gonzalez-Sanchez? 
...
public class Assignment {
	 ...
	 * 
	 * This method takes input from the user to allow testing various scenarios for
	 * the GameBoard and GamePiece classes.
	 */
	public static void main(String[] args) {
		...
		while (!inputString.equalsIgnoreCase("Q")) {
			...
			if (board.isSpaceValid(row, col)) {
				// add the piece
				if (board.addPieceAt(row, col, piece)) {
